<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/Developer/developer.master" AutoEventWireup="true" CodeFile="MobileAndOs.aspx.cs" Inherits="Developer_MobileAndOs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<div class="container">
		<h3 class="text-center">Mobile And Os</h3>
	</div>
</section>
    ...
    background: #f4f8fb;">
							...
							<div class="form-group">
                                ...
                                <asp:TextBox ID="txtmobile" runat="server" type="text" placeholder="Mobile Name" class="form-control"></asp:TextBox>
							</div>
							<div class="form-group">
								<%--<input type="text" name="phone" class="form-control" placeholder="Phone Number" required="">--%>
                                 <asp:TextBox ID="txtos" runat="server" type="text" class="form-control"  placeholder="Mobile Os"></asp:TextBox>
							</div>
							<%--<div class="form-group">
